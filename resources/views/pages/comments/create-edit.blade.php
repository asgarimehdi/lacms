<div>
    ...
    <x-card shadow>
        <div class="space-y-4">
            <div>
                <x-label value="Post" class="text-base-content/60 mb-1" />
                @if($comment->post)
            ...
            <div>
                <x-label value="Author" class="text-base-content/60 mb-1" />
                <span>{{ $comment->author_name }} <{{ $comment->author_email }}></span>
            </div>

            <div>
                <x-label value="Comment" class="text-base-content/60 mb-1" />
            ...
            <div>
                <x-label value="Status" class="text-base-content/60 mb-1" />
            ...
            <div>
                <x-label value="Submitted" class="text-base-content/60 mb-1" />
