...
<?php $component = Mary\View\Components\Header::resolve(['title' => $page ? __('cms.edit') : __('cms.create'),'separator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => __('cms.back'),'link' => ''.e(route('admin.pages.index')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
</div><?php /**PATH C:\laragon\www\lacms\resources\views\pages\pages\create-edit.blade.php ENDPATH**/ ?>