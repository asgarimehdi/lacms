...
<?php $component = Mary\View\Components\Header::resolve(['title' => 'Users','separator' => true,'progressIndicator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'delete('.e($user['id']).')','wire:confirm' => 'Are you sure?','class' => 'btn-ghost btn-sm text-error']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
</div><?php /**PATH C:\laragon\www\lacms\storage\framework\views/livewire/views/48ed2b8c.blade.php ENDPATH**/ ?>