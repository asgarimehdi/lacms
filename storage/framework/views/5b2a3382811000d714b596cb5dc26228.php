...
<?php $component = Mary\View\Components\Header::resolve(['title' => $category ? __('cms.edit') : __('cms.create'),'separator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => __('cms.back'),'link' => ''.e(route('admin.categories.index')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Input::resolve(['label' => __('cms.category_name')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
</div><?php /**PATH C:\laragon\www\lacms\resources\views\pages\categories\create-edit.blade.php ENDPATH**/ ?>