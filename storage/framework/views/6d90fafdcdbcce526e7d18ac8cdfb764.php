    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="md:w-96 w-full">
            <div class="text-center mb-8">
                ...
                <p class="text-base-content/60 mt-1"><?php echo e(__('cms.sign_in_to_continue')); ?></p>
            </div>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Create an account','link' => '/register'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
</div><?php /**PATH C:\laragon\www\lacms\storage\framework\views/livewire/views/67777f7f.blade.php ENDPATH**/ ?>